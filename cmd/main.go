...
import (
	...
	"github.com/zhengzhihua2017/box-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "015ee764.zhengzhihua2017.com",
	...
	if err := (&controller.BoxControllerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BoxController")
		os.Exit(1)
	}
